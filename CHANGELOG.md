...
- The "Privacy Policy" link on the sign-in and sign-up screens now opens the Data & Privacy page. Both it and a "Terms of Service" link next to it were buttons with no handler, so they looked like the usual legal links and did nothing. The terms link is gone rather than pointing somewhere: there are no terms written, and a dead legal link is worse than none. Documentation sections can now be linked directly by URL, which is what makes the privacy link land on the right page.
