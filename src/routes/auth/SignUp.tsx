      ...
      <div className="relative z-10 flex flex-col items-center w-full max-w-[360px] px-4">
        ...
        <div className="w-full rounded-xl p-6 flex flex-col gap-4"
          ...
          <div className="flex flex-col gap-1">
            <label className="text-[12px] text-[#A1A1AA]">Work email</label>
          ...
          <button
            onClick={onSignUp}
            className="w-full h-9 rounded-lg text-[13px] font-semibold text-white transition-opacity hover:opacity-90 flex items-center justify-center gap-2 mt-1"
